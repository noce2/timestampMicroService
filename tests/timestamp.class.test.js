...
const Timestamp = require(path.resolve(process.cwd(),
                    './app/timestamp.class.js')).Timestamp;
// Directory works because the code will be initiated from package.json in root
...
describe('Timestamp Class', function() {
    ...
    describe('TimestampMaker.timestampMaker("6 May 2017")', function() {
     it('should return {"unix":1494028800,"natural":"6 May 2017"}', function() {
         assert.deepEqual(Timestamp.timestampMaker('6 May 2017'),
            {'unix': 1494028800, 'natural': '6 May 2017'});
     });
    });

    describe('TimestampMaker.timestampMaker("1494159294")', function() {
     it('should return {"unix":1494159294,"natural":"7 May 2017"}', function() {
         assert.deepEqual(Timestamp.timestampMaker('1494159294'),
            {'unix': 1494159294, 'natural': '7 May 2017'});
     });
    });
});
